...
public class LoadingScreen extends JFrame{
    ...
    public LoadingScreen(){
        ...
        upperPic = new JLabel();
        upperPic.setIcon(new ImageIcon(ClassLoader.getSystemResource("elearningsystem/icons/loadingIconImg.png")));
        ...
        backgroundPic.setIcon(new ImageIcon(ClassLoader.getSystemResource("elearningsystem/icons/background.png")));
        ...
        try{
            for(int i=0; i<=100; i++){
                ...
                if(i==10){
                   ...
                   loadingLbl.setText("Lauching 3K Application...");
                }
                else if(i==100){
                    new Main();
                    dispose();
