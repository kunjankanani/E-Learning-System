...
public class Main extends JFrame implements ActionListener{
    ...
    public Main(){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("elearningsystem/icons/MainTitle.png"));
        ...
        //Main Center Code
        ImageIcon loginImg1 = new ImageIcon(ClassLoader.getSystemResource("elearningsystem/icons/login.png"));
        ...
        ImageIcon signUpImg1 = new ImageIcon(ClassLoader.getSystemResource("elearningsystem/icons/signup.png"));
        ...
        ImageIcon mainPic1 = new ImageIcon(ClassLoader.getSystemResource("elearningsystem/icons/ElearningMain.png"));
        ...
        // Footer Panel Code
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("elearningsystem/icons/footer.png"));
